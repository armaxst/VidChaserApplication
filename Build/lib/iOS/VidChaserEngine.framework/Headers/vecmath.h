...
namespace gl_helper
{
	...
	*/
	...
	public:
		...
		void Dump()
		{
			//printf( "%f %f %f %f", f_[0], f_[1], f_[2], f_[3] );
			//printf( "%f %f %f %f", f_[4], f_[5], f_[6], f_[7] );
			//printf( "%f %f %f %f", f_[8], f_[9], f_[10], f_[11] );
			//printf( "%f %f %f %f", f_[12], f_[13], f_[14], f_[15] );
		}
	};
